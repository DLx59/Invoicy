...
export class InvoiceFormGroupService {
  ...
  private createFormGroup(): FormGroup {
    return new FormGroup({
      clientCity: new FormControl<string>('', {nonNullable: true}),
      clientCountry: new FormControl<string>('', {nonNullable: true}),
      ...
      clientStreet: new FormControl<string>('', {nonNullable: true}),
      ...
      issuerStreet: new FormControl<string>('', {nonNullable: true}),
      issuerVAT: new FormControl<string>('', {nonNullable: true}),
      issuerWebsite: new FormControl<string>(''),
      issuerZipCode: new FormControl<string>('', {nonNullable: true}),
